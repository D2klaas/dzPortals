...
## Zone
<img align="left" width="225" height="225" alt="Zone Gizmo in editor" src="screens/zone-icon.PNG"> Zone should containe all visual instances of the defining space. If the zone is culled it gets hidden and so do all of its children nodes.
